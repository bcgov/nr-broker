...
@Embeddable({ discriminatorValue: ACTION_NAMES.PROCESS_START })
export class ProcessStartActionEmbeddable extends ActionEmbeddable {
  constructor(
    action: ActionDto,
    ...
    this.action = ACTION_NAMES.PROCESS_START;
  }
}
