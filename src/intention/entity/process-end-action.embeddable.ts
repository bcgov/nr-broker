...
@Embeddable({ discriminatorValue: ACTION_NAMES.PROCESS_END })
export class ProcessEndActionEmbeddable extends ActionEmbeddable {
  constructor(
    action: ActionDto,
    ...
    this.action = ACTION_NAMES.PROCESS_END;
  }
}
