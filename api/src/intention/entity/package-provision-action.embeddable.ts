...
@Embeddable({ discriminatorValue: ACTION_NAMES.PACKAGE_PROVISION })
export class PackageProvisionActionEmbeddable extends ActionEmbeddable {
  constructor(
    action: ActionDto,
    ...
    this.action = ACTION_NAMES.PACKAGE_PROVISION;
  }
}
