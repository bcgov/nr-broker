...
@Embeddable({ discriminatorValue: ACTION_NAMES.PACKAGE_CONFIGURE })
export class PackageConfigureActionEmbeddable extends ActionEmbeddable {
  constructor(
    action: ActionDto,
    ...
    this.action = ACTION_NAMES.PACKAGE_CONFIGURE;
  }
}
