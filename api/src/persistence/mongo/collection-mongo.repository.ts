      ...
      ? [
          {
            $graphLookup: {
              ...
              as: 'upstream_path',
              maxDepth: includeRestricted ? 1 : GRAPH_MAX_UPSTREAM_LOOKUP_DEPTH,
              ...(includeRestricted ? {} : { restrictSearchWithMatch: { restrict: { $ne: true } } }),
            },
          },
          {
            $match: {
      ...
      ? [
          {
            $graphLookup: {
              ...
              as: 'downstream_path',
              maxDepth: includeRestricted ? 1 : GRAPH_MAX_DOWNSTREAM_LOOKUP_DEPTH,
              ...(includeRestricted ? {} : { restrictSearchWithMatch: { restrict: { $ne: true } } }),
            },
          },
          {
